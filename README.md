...
| Главный экран (часы) | Экран управления (часы) | Настройки (телефон) |
|:---:|:---:|:---:|
| ![Главный экран](docs/watch_01.jpg) | ![Экран управления](docs/watch_02.jpg) | ![Настройки](docs/phone.jpg) |
| Статус, метрики | Удержание 3с для команды | Аккаунт, устройства, виджеты |
...
- **Двухэкранный UI** — главный экран (статус + метрики), экран управления (свайп влево)
...
│   │   └── actions.js              # Экран управления: кнопки двигателя, охраны, обновления (hold 3s)
│   └── shared/
